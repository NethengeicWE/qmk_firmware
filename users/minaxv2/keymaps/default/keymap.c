...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [0] = LAYOUT_minax(
        ...
        KC_6    ,KC_Y   ,KC_H   ,KC_N   ,KC_SPC ,KC_RALT,KC_M   ,KC_J   ,KC_U   ,KC_7   ,
   ...
   [1] = LAYOUT_minax(
        ...
        KC_ESC  ,_______,_______,_______,_______,_______,_______,_______,_______,KC_F1  ,
        KC_F2   ,_______,_______,_______,_______,_______,_______,_______,_______,KC_F3  ,
        KC_F4   ,_______,_______,_______,_______,        _______,_______,_______,KC_F5  ,
        KC_F6   ,_______,_______,_______,_______,KC_UP  ,_______,_______,_______,KC_F7  ,
        KC_F8   ,_______,_______,_______,_______,KC_DOWN,_______,_______,_______,KC_F9  ,
        KC_F10  ,_______,_______,_______,KC_LEFT,KC_RGHT,_______,_______,_______,KC_F11 ,
    ...
    [2] = LAYOUT_minax(
        ...
        _______ ,_______,_______,_______,_______,_______,_______,KC_LEFT,LCTL(LGUI(KC_LEFT)),KC_MUTE,
        KC_VOLD ,KC_UP  ,KC_DOWN,_______,_______,_______,_______,KC_RGHT,LCTL(LGUI(KC_RGHT)),KC_VOLU,
        _______ ,_______,_______,_______,_______,       RGB_ANIM,HF_TOGG,NK_TOGG,_______,
        _______ ,CL_TOGG,KO_TOGG,RGB_MOD,_______,_______,RGB_RMOD,RGB_HUI,_______,_______,
        _______ ,HF_DWLU,RGB_HUD,RGB_VAI,RGB_VAD,_______,RGB_SAD,RGB_SPI,HF_DWLD,_______,
        _______ ,_______,RGB_SPD,_______,_______,_______,_______,RGB_SAI,_______,_______,
...
bool rgb_matrix_indicators_user(void){
    ...
    int16_t x = analogReadPin(joystick_x_axis);
    int16_t y = analogReadPin(joystick_y_axis);
    #ifdef CONSOLE_ENABLE
        // debug
        // uprintf("x: %hd,y:%hd,lr:%d,ud:%d\n", x,y,isLRpressed,isUDpressed);
    #endif
