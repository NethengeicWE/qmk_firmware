...
#define KC_LWIN LCTL(LGUI(KC_LEFT))
#define KC_RWIN LCTL(LGUI(KC_RGHT))
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [1] = LAYOUT_minax(
    ...
    [2] = LAYOUT_minax(
        ...
        _______ ,_______,_______,_______,_______,_______,_______,_______,_______,_______,
        _______ ,_______,_______,_______,_______,_______,_______,        _______,_______,
        _______ ,_______,_______,_______,_______,_______,KC_F1  ,KC_F5  ,KC_F9  ,KC_MUTE,
        KC_VOLU ,KC_F10 ,KC_F6  ,KC_F2  ,_______,KC_LWIN,KC_F3 ,KC_F7  ,KC_F11  ,KC_VOLD,
        RGB_ANIM,KC_F12 ,KC_F8  ,KC_F4  ,_______,        KC_ENT ,KC_DEL ,_______,RGB_MOD,
        RGB_HUI ,_______,KC_HOME,KC_END ,KC_RWIN,_______,_______,_______,_______,RGB_SAI,
        RGB_VAI ,_______,_______,_______,_______,_______,_______,_______,_______,RGB_SPI,
        HF_TOGG ,_______,_______,_______,_______,_______,_______,_______,_______,HF_DWLU,
        _______ ,_______,_______,_______,_______
    )
    // Strange game
...
bool process_record_kb(uint16_t keycode, keyrecord_t *record){
    ...
    switch(keycode){
        case RGB_ANIM: // rgb_switch
            ...
            return true;
        case HF_TOGG: // rgb_switch
            if (record -> event.pressed) hf_togg ^= 1; 
            return true;
        case NK_TOGG: // rgb_switch
            if (record -> event.pressed) nk_togg ^= 1; 
            return true;
        default:
            return true;
    }
...
// RGB指示灯
HSV hsv_custom = {0, 255, 255};
RGB rgb_custom = {0, 0, 0};
// RGB指示灯
#ifdef RGB_MATRIX_ENABLE
bool rgb_matrix_indicators_kb(void) {
    hsv_custom.h = rgb_matrix_get_hue();
    hsv_custom.s = rgb_matrix_get_sat();
    hsv_custom.v = rgb_matrix_get_val();
    ...
    if (get_highest_layer(layer_state) == 2) {
        ...
        // rgb anim
        rgb_anim == 1? rgb_matrix_set_color(8, 0, 255  , 0):rgb_matrix_set_color(8, 255, 0  , 0); 
        // rgb config
        // hsv：色调，饱和度，亮度
        // 数字有问题
            // rgb_mode
            hsv_custom.h = rgb_matrix_get_mode();
            rgb_custom = hsv_to_rgb(hsv_custom);
            rgb_matrix_set_color(9, rgb_custom.r,rgb_custom.g,rgb_custom.b);
            // rgb_hue
            hsv_custom.h = rgb_matrix_get_hue();
            rgb_custom = hsv_to_rgb(hsv_custom);
            rgb_matrix_set_color(10, rgb_custom.r,rgb_custom.g,rgb_custom.b);
            // rgb_sat
            hsv_custom.h = rgb_matrix_get_sat();
            rgb_custom = hsv_to_rgb(hsv_custom);
            rgb_matrix_set_color(11, rgb_custom.r,rgb_custom.g,rgb_custom.b);
            // rgb_val
            hsv_custom.h = rgb_matrix_get_val();
            rgb_custom = hsv_to_rgb(hsv_custom);
            rgb_matrix_set_color(12, rgb_custom.r,rgb_custom.g,rgb_custom.b);
            // rgb_spd
            hsv_custom.h = rgb_matrix_get_speed();
            rgb_custom = hsv_to_rgb(hsv_custom);
            rgb_matrix_set_color(13, rgb_custom.r,rgb_custom.g,rgb_custom.b);
        // hf_tog
        hf_togg == 1? rgb_matrix_set_color(14, 0, 255, 0):rgb_matrix_set_color(14, 255, 0, 0);
        // HF_DWLU
        rgb_matrix_set_color(15, 255,255,255);
        // NK_TOGG
        nk_togg == 1? rgb_matrix_set_color(16, 0, 255, 0):rgb_matrix_set_color(16, 255, 0, 0);   
    }
...
/*
        TO(0)  ,KC_7   ,KC_4      ,KC_1     ,KC_BSPC,KC_0   ,KC_2      ,KC_5      ,KC_8      ,KC_PAST,
        KC_PSLS,KC_9   ,KC_6      ,KC_3     ,KC_DOT ,KC_BTN2,_______   ,           KC_PPLS   ,KC_PMNS,
        KC_ESC ,_______,_______   ,_______  ,_______,_______,KC_1      ,KC_4      ,KC_7      ,KC_PDOT,
        KC_0   ,KC_8   ,KC_5      ,KC_2     ,_______,_______,KC_3      ,KC_6      ,KC_9      ,KC_PSLS, 
        KC_PAST,KC_PMNS,KC_PPLS   ,KC_ENT   ,_______,        S(KC_COMM),KC_BSLS   ,S(KC_BSLS),_______,
        _______,_______,KC_SCLN   ,S(KC_DOT),_______,_______,KC_COMM   ,S(KC_SCLN),KC_LBRC   ,_______,
        _______,KC_RBRC,S(KC_LBRC),_______  ,_______,_______,_______   ,S(KC_RBRC),S(KC_9)   ,_______,
        _______,S(KC_0),_______   ,_______  ,_______,_______,_______   ,_______   ,_______   ,NK_TOGG,
        _______,_______,_______   ,_______  ,_______
*/
